...
#define TEST_NAME "LockFreeLinkedMemCache: Parallel stress test. Ordered acquire/release"
TEST_CASE(TEST_NAME, "[LockFreeLinkedMemCache]") {
...
#define TEST_NAME "LockFreeLinkedMemCache: Parallel stress test. Random acquire/release"
TEST_CASE(TEST_NAME, "[LockFreeLinkedMemCache]") {
    const std::size_t minFreeBlocksCount{100};
    LockFreeLinkedMemCache memCache{minFreeBlocksCount, sizeof(float)};
...
#define TEST_NAME  "LockFreeLinkedMemCache: Parallel stress test. Random acquire/release. Verify data"
TEST_CASE(TEST_NAME, "[LockFreeLinkedMemCache]") {
    const std::size_t minFreeBlocksCount{100};
